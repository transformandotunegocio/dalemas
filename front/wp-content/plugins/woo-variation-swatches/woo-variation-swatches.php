<?php
/**
 * Plugin Name: WooCommerce Variation
 * Description: Manejo de variaciones
 * Author: 
 * Version: 1.0.0
...
if ( ! class_exists( 'Woo_Variation_Swatches' ) ):
	...
	final class Woo_Variation_Swatches {
		...
		public function plugin_action_links( $links ) {
			...
			if ( ! $this->is_pro_active() ):
				$new_links['go-pro'] = sprintf( '', esc_url( $pro_link ), esc_attr__( 'Go Pro', 'woo-variation-swatches' ) );
			endif;
